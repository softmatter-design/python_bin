...
def makenewudf():
	...
	\\begin{data}
		...
		TargetCond:{
			...
			{"Entangled",
				{[1.073,1.0,0.9,0.8], {1.0e-02,1000000,10000}},
				{2.0, [0.2,0.5,1.0,2.0,3.0,4.5], {1.0e-02,1000000,10000}}
				}
			}
		SimulationCond:{
			...
			{"Yes",
				{"single", [{1.15, 1, 0.2, 1.15, {1.0e-03,2000000,20000}}, {1.15, 1, 0.2, 1.15, {1.0e-03,2000000,20000}}, {1.15, 1, 0.2, 1.15, {1.0e-03,2000000,20000}},{1.15, 1, 0.2, 1.15, {1.0e-03,2000000,20000}},{1.15, 1, 0.2, 1.15, {1.0e-03,2000000,20000}}],
				{1.0e-3, 100000, 1000},
				{3,{1.0e-02,1000000,10000}}
				}
			}
