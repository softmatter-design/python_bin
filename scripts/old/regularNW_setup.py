...
##################
# pythonの場所
shebang = "#!/home/octa/OCTA85/Python310/bin/python"
# 使用するCognacのバージョンを入れてください。
ver_cognac = "cognac112"
blank_udf = 'cognac112.udf'
# ベースとするUDFの名前
base_udf = "base_uin.udf"
# 計算に使用するコア数
core = 6
###########
files_cond = [ver_cognac, blank_udf, base_udf, core, shebang]
#######################################################
## 計算ターゲット
###################
## Networkモデルの設定
...
#py_mod = '/home/octa/OCTA85/pyscript_octa/python_modules'
	#
